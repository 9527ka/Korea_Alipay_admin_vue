<template>
    <div>
        ...
        <el-card class="!border-none" v-loading="pager.loading" shadow="never">
            <el-button v-perms="['pledge/add']" type="primary" @click="handleAdd">
                <template #icon>
...
<script lang="ts" setup name="pledgeLists">
import { usePaging } from '@/hooks/usePaging'
import { useDictData } from '@/hooks/useDictOptions'
import { apiPledgeLists, apiPledgeDelete } from '@/api/pledge'
